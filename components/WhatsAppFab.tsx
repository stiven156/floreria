...
export function WhatsAppFab({ settings }: { settings: StoreSettings }) {
  ...
  return (
    <a
      ...
      className="animate-float fixed bottom-5 right-5 z-30 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)] ring-4 ring-white/40 transition-transform hover:scale-105"
    >
